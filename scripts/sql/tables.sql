...
CREATE TABLE
    IF NOT EXISTS "Lineups" (
        ...
        CONSTRAINT "FK_Maps_MapID" FOREIGN KEY ("MapID") REFERENCES "Maps" ("ID") ON DELETE RESTRICT ON UPDATE CASCADE,
        CONSTRAINT "FK_MapPositions_FromMapPositionID" FOREIGN KEY ("FromMapPositionID") REFERENCES "MapPositions" ("ID") ON DELETE RESTRICT ON UPDATE CASCADE,
        CONSTRAINT "FK_MapPositions_ToMapPositionID" FOREIGN KEY ("ToMapPositionID") REFERENCES "MapPositions" ("ID") ON DELETE RESTRICT ON UPDATE CASCADE,
        CONSTRAINT "FK_Users_CreatedBy" FOREIGN KEY ("CreatedBy") REFERENCES "Users" ("UserID") ON DELETE SET NULL ON UPDATE CASCADE,
